      ...
      <Container maxW="container.x1" bg="spikk-inner-page-bg" color="white">
        ...
        >
          <VStack
            ...
            alignItems="left"
            mr={{ base: '0', xs: '0', sm: '0', md: '10', lg: '10' }}
            mb={{ base: '10', xs: '10', sm: '10', md: '10', lg: '0' }}
          >
            <VStack
              alignItems="left"
              borderRadius="20px"
            ...
            >
              ...
              <HStack fontSize="md" p={3}>
                ...
                <Spacer />
                <Text fontSize="xs">#45271b34</Text>
              </HStack>
              <HStack fontSize="md" p={3}>
                <Text fontSize="xs">10th June, 2021</Text>
                <Spacer />
                <Text fontSize="xs">10:02 AM</Text>
              </HStack>
            </VStack>
            <VStack
              alignItems="left"
            ...
            >
              ...
              <HStack p={5} fontSize="13px">
                ...
                />
                <Spacer />
                <Text>You ordered Bread and Pringles</Text>
                <Spacer />
                <Text>10th June</Text>
              </HStack>
              ...
              >
                <Box>
                  ...
                  <Box p={5}>
                    ...
                    <Flex p={5}>
                      <Image
                        src={require('../../assets/images/receipt.png')}
                        height="40px"
                        alt="item"
                      />
                ...
                <Box>
                  ...
                  <HStack alignItems="left" p={5} fontSize="13px">
                    ...
                    <VStack>
                      ...
                      <Text>We received your order at 10:02AM</Text>
                    </VStack>
                  </HStack>
                  <HStack alignItems="left" p={5} fontSize="13px">
                    <Image
                      src={require('../../assets/images/accepted.png')}
                      height="25px"
                      alt="item"
                    />
                    <VStack>
                  ...
                  <HStack alignItems="left" p={5} fontSize="13px">
                    <Image
                      src={require('../../assets/images/greenbike.png')}
                      width="30px"
                      height="25px"
                      alt="item"
                    />
