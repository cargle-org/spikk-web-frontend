          ...
          >
            ...
            <GridItem position="relative">
              <Text
                ...
                top="-20px"
                color="#919191"
                fontSize={{ base: '10px', sm: '9px', lg: '13px' }}
              >
                We will send an <b>OTP</b> to your <b>email address</b> for
                verification
              </Text>
              <InputGroup>
                <InputLeftElement
            ...
            <GridItem>
              ...
              <Text color="#919191" fontSize="13px" marginTop="10px">
                {' '}
                Password must be at least <b>8 characters long</b>, including at
                least <b>1 uppercase alphabet, a number</b> and{' '}
                <b>a special character</b>
              </Text>
            </GridItem>
            <GridItem>
              <InputGroup>
