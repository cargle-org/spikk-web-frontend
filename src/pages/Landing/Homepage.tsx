    ...
    <Box as="section" bg="spikk-dark-bg">
          ...
          <Box>
            ...
            >
              ...
              >
                ...
                >
                  Spikk has got you covered. Spikk saves you time and energy so
                  you can relax and have us run that errand or pick up and
                  deliver.
                </Text>
              </Box>
              <Flex
        ...
        <VStack maxW="648px" marginX="auto" paddingX="16px">
          ...
          >
            <Text>
              ...
              dedicated shoppers that run errands and deliver top notch
              services.
            </Text>
            <Text marginTop={{ base: '8px', md: '0' }}>
              Spikk is dedicated to empowering people, communities and making
              life a lot easier.
            </Text>
          </Text>
        </VStack>
      ...
      <Box textAlign="center" marginTop="40px" paddingBottom="120px">
        <Box
          ...
          margin="0 auto"
          position="relative"
          padding={{ base: '0 32px', md: '' }}
        >
          <Image
            src={
              require('../../assets/images/homepage/about-banner-2.svg').default
            }
          ...
          >
            ...
            <Text lineHeight="20px" color="spikk-white">
              List the item(s) you want to buy or send and we will connect you
              to the best Pickers that run errands and deliver top notch
              services.
            </Text>
          </Box>
          <Box
          ...
          >
            ...
            <Text lineHeight="20px" color="spikk-white">
              Get a real-time update on the status of your request from start to
              finish{' '}
            </Text>
          </Box>
          <Box
          ...
          >
            ...
            <Text lineHeight="20px" color="spikk-white">
              You can pay from your Spikk wallet when funded or simply pay the
              Picker with cash once your request is completed
            </Text>
          </Box>
          <Box
            position={{ base: 'initial', lg: 'absolute' }}
          ...
          >
            ...
            <Text lineHeight="20px" color="spikk-white">
              We want your next experience to be the best; let us know how we
